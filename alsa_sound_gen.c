...
//dang ký platform driver cho kernel
static int __init alsa_soundgen_card_init(void)
{
        int err;
//dang ký và d?t driver vào danh sách các driver duy trì b?i kernel
...
//dang ký platform device vào platform driver
